package com.doctormanagement.security.jwt;
...
import com.doctormanagement.security.services.UserPrinciple;
...
public class JwtProvider {
    ...
    @Value("${doctormanagement.app.jwtSecret}")
    private String jwtSecret;
 
    @Value("${doctormanagement.app.jwtExpiration}")
